...
class InfiniteMPS(BaseMPS):
  ...
  def canonicalize(self,
    ...
    l.tensor = (
        l.tensor + self.backend.transpose(self.backend.conj(l.tensor),
                                          (1, 0))) / 2.0
    ...
    inveigvals_left[
        eigvals_left > pinv] = 1.0 / eigvals_left[eigvals_left > pinv]
    ...
    self._tensors[-1] = ncon.ncon([self._tensors[-1], self.connector, invy, U],
                                  [[-1, 1, -3], [1, 2], [2, 3], [3, -2]])
