...
class FiniteTFI2D(FiniteMPO):
  """
  The transverse field Ising MPO, H = sum_<ij> sigx_i * sigx_j + sum_j sigz_j
  Basis convention is sigz = diag([-1,1]).
  """
  ...
  def __init__(self,
               ...
               name: Text = '2DTFI_MPO'):
    """
    Returns the MPO of the finite 2-dimensional transverse
    field Ising model on an N1 by N2 grid. The MPO is snaked
    along the vertical direction.

    Args:
      Jx1: The sigma_x*sigma_x coupling strength in vertical direction.
      Jx2: The sigma_x*sigma_x coupling strength in horizontal direction.
      Bz:  Magnetic field strength on each lattice site.
    ...
    Returns:
      FiniteTFI2D: The mpo of the TFI model on an N1 x N2 grid.
    """
