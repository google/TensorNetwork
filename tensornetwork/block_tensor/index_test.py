...
from tensornetwork.block_tensor.index import Index, fuse_index_pair, split_index, fuse_indices
...
def test_split_index():
  ...
  assert i1 is i1_
  assert i2 is i2_
  np.testing.assert_allclose(q1.charges, i1.charges.charges)
  np.testing.assert_allclose(q2.charges, i2.charges.charges)
  np.testing.assert_allclose(q1.charges, i1_.charges.charges)
  np.testing.assert_allclose(q2.charges, i2_.charges.charges)
...
def test_elementary_indices():
  ...
  i3 = Index(charges=q3, flow=False, name='index3')
  i4 = Index(charges=q4, flow=False, name='index4')
  ...
  np.testing.assert_allclose(q1.charges, i1.charges.charges)
  np.testing.assert_allclose(q2.charges, i2.charges.charges)
  np.testing.assert_allclose(q3.charges, i3.charges.charges)
  np.testing.assert_allclose(q4.charges, i4.charges.charges)
