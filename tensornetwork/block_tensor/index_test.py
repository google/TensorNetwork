...
def test_index_fusion_mul():
  ...
  for n in range(len(i12.charges.charges)):
    assert np.all(i12.charges == (q1 + q2).charges)
...
def test_split_index():
  ...
  assert i1 is i1_
  assert i2 is i2_
  np.testing.assert_allclose(q1.charges, i1.charges)
  np.testing.assert_allclose(q2.charges, i2.charges)
  np.testing.assert_allclose(q1.charges, i1_.charges)
  np.testing.assert_allclose(q2.charges, i2_.charges)
...
def test_elementary_indices():
  ...
  np.testing.assert_allclose(q1.charges, i1.charges)
  np.testing.assert_allclose(q2.charges, i2.charges)
  np.testing.assert_allclose(q3.charges, i3.charges)
  np.testing.assert_allclose(q4.charges, i4.charges)
