...
from tensornetwork.block_tensor.block_tensor import _find_diagonal_sparse_blocks, compute_num_nonzero, find_sparse_positions, find_dense_positions, BlockSparseTensor, fuse_ndarrays
...
def test_find_dense_positions():
  ...
  dense_positions = find_dense_positions(
      U1Charge(left_charges), 1, U1Charge(right_charges), 1,
...
def test_find_dense_positions_2():
  ...
  positions = find_dense_positions(i01.charges, 1, i23.charges, 1,
...
def test_find_sparse_positions():
  ...
  blocks = find_sparse_positions(
      i01.charges, 1, i23.charges, 1, target_charges=U1Charge(np.asarray([0])))
